...
% Create the Gray Level Cooccurance Matrices 
...
load('Healthy.mat')
load('Bacterial_Leaf_Spot.mat')
load('Moises.mat')

%% Disease classification
T = [Healthy;Bacterial_Leaf_Spot;Moises];
...
if result == 0
    ...
    disp(' Healthy ');
elseif result == 1
    helpdlg(' Bacterial Leaf Spot ');
    disp('Bacterial Leaf Spot');
elseif result == 2
    helpdlg(' Moises ');
    disp(' Moises ');
