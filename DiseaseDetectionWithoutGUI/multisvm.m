...
% Updated Date:04-03-2019(DD-MM-YYYY)
% orignally this function had used svmtrain,svmclassify but these are removed from matlab
% since 2018a hence Its been modify this function with fitcsvm and predict respectively.  
itrind=size(test,1);
itrfin=[];
Cb=C;
Tb=T;
